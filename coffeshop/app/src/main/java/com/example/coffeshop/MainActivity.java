...
public class MainActivity extends AppCompatActivity {
    ...
    public void Submitorder(View view) {
        ...
        CheckBox caramelChekBox= (CheckBox) findViewById(R.id.Caramel_checkbox);
        boolean hascaramel=caramelChekBox.isChecked();//mengidentifikasi check
        Log.v("MainActivity","has whippedcream:"+hascaramel);

        int price=calculateprice(haswhippedcream,haschocolate,hascaramel);//memanggil method jumlah harga
    ...
    private int calculateprice(boolean addwhipedcream,boolean addchocolate,boolean addcaramel){//jumlah pesanan * harga
        int harga=5000;
    ...
    private String createOrderSummary(int price, String name, boolean addChocolate, boolean addWhippedCream,boolean addCaramel) {//hasil pemesanan
        String pricemessage=" Nama ="+name;
        pricemessage+="\n add Whipped Cream?"+addWhippedCream;
        pricemessage+="\n add Chocolate?"+addChocolate;
        pricemessage+="\n add Chocolate?"+addCaramel;
        pricemessage+="\n quantity"+quantity;
        pricemessage+="\n Total Rp"+price;
        pricemessage+="\n Thankyou";
        return  pricemessage;
